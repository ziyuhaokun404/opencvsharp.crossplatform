...
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Application.Pipeline;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Application.Ports;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Application.Workbench;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Operators;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Services;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.ViewModels.Models;
using CvPoint = OpenCvSharp.Point;
using CvRect = OpenCvSharp.Rect;
using CvSize = OpenCvSharp.Size;

namespace OpenCvSharp.Mac.Samples.Workbench.Avalonia.ViewModels;
