...
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Infrastructure.OpenCv;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.Services;
using OpenCvSharp.Mac.Samples.Workbench.Avalonia.ViewModels;
using AvaloniaWindow = Avalonia.Controls.Window;

namespace OpenCvSharp.Mac.Samples.Workbench.Avalonia.Views;
