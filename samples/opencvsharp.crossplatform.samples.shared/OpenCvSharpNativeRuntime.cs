...
namespace OpenCvSharp.CrossPlatform.Samples.Shared;
...
public static class OpenCvSharpNativeRuntime
{
    ...
    public static void Register()
    {
        ...
        {
            // OpenCvSharp4.runtime.win* NuGet packages copy native DLLs to the output directory.
            isRegistered = true;
            return;
        }
        ...
        if (!OperatingSystem.IsMacOS())
            throw new PlatformNotSupportedException(
                "Local OpenCvSharp native runtime loading is only configured for macOS. " +
                "On other platforms, reference the appropriate OpenCvSharp4.runtime.* NuGet package.");
